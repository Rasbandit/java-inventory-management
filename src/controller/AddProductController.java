...
/** The controller for the AddProduct scene. */
public class AddProductController implements Initializable {
    ...
    Integer autoGeneratedId = 100;


    /** Update the selected and all parts table's content. */
    ...
    @FXML
    /** Add the selected part from the AllParts table to the product. */
    public void addPart() {
    ...
    @FXML
    /** Remove the selected part from the SelectedParts table. */
    ...
    public void saveProduct(ActionEvent actionEvent) throws IOException {
        ...
        Product newProduct = new Product(autoGeneratedId++, nameInput.getText(), price, stock, min, max, selectedParts);
    ...
    @FXML
    /** Filter the shown parts in the AllProducts table. */
    ...
    @Override
    /** Sets initial values and when the scene is loaded. */
